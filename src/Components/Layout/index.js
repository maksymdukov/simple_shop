...
const BGIMAGE_MAP = {
    ...
    "Burger Builder":
        "https://mrgrill.com.ua/wp-content/uploads/2017/09/banner.jpg",
    ...
    Contacts:
        "https://mrgrill.com.ua/wp-content/uploads/2017/09/bg_contacts.jpg",
        ...
        <Fragment>
            <Helmet
                ...
                onChangeClientState={newState =>
                    newState.title
                        ? setTitle(newState.title.split(TITLE_PREFIX)[1])
                        : setTitle("")
                }
            />
            <header
                ...
                style={{
                    backgroundImage: `url(${BGIMAGE_MAP[title] ||
                        BGIMAGE_MAP.default})`
                }}
            >
                <MyToolbar
